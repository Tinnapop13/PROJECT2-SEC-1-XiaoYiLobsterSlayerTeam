    ...
    <div class="flex flex-col justify-evenly items-center">
      ...
      <div class="flex flex-col  bg-[#a6bbc8] p-4 rounded-2xl w-full">
        ...
        <div>
          ...
          <input type="text" class="bg-white w-full border border-gray-300 p-0.5 outline-none rounded-lg"
        ...
        <div>
          <p class="text-base font-bold text-blue-950">PainPoint : </p><input type="text"
            class="bg-white w-full border border-gray-300 p-0.5 outline-none rounded-lg" v-model="newCard.PainPoint" />
        </div>
        <div>
        ...
        <div class="flex flex-col w-[30vw]">
          ...
          <input type="range" min="1" max="10" v-model="newCard.Rating.responsibility" class="slider my-1" id="myRange">
        </div>
